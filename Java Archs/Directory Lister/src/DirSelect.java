...
public class DirSelect {
    ...
    static private JButton saveRunButton;
    ...
    private void DirSelectSetup() {
        ...
        saveRunButton = d.getSaveRunButton();
    ...
    private void SetupActions() {
        ...
        saveRunButton.addActionListener(new SaveChangeViaButton());
    }
